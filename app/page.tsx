  ...
  return (
      <div className="relative mx-auto my-2 flex max-w-7xl flex-col items-center justify-center">
        ...
        <div className="px-4 md:px-8 lg:px-16 py-4 md:py-8">
          <h1 className="relative z-10 mx-auto max-w-4xl text-center text-2xl font-bold md:text-4xl lg:text-5xl">
            <motion.span
              ...
              className="mr-2 inline-block text-black dark:text-white italic"
            >
              Fibra
            </motion.span>
            <motion.span
              ...
              className="mr-2 inline-block text-[#FF0000] italic"
            >
              Points
            </motion.span>
          </h1>
          <motion.p
            ...
            className="relative z-10 mx-auto max-w-xl py-2 text-center text-sm font-normal text-[#FF0000]"
          >
    ...
    <nav className="flex w-full items-center justify-between border-t border-b border-neutral-200 px-4 py-2 dark:border-neutral-800">
      <div className="flex items-center gap-2">
        ...
        <div className="bg-black px-2 py-1 rounded">
          <h1 className="text-base font-bold md:text-2xl italic">
